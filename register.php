<?php
   if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO users (f_name, l_name, email , password, role, img_path)
    ...
    if (mysqli_query($dbCon, $sql)) {
        ...
        $week = (int)$week;
        $week10=$week+10;
        $insertNewConstSql = "INSERT INTO `const` (`id`, `week_id`, `day_id`, `user_id`, `shift_id`, `status`, `published`) VALUES ";
        // $insertNewConstSql="";
